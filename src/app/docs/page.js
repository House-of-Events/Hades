...
export default function DocsPage() {
  ...
  const steps = [
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-600 mt-4">
            To use our API, you'll need to create an account first. This will
            give you access to your unique API key.
          </p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-gray-600 mb-3">
              Go to our sign up page and create your account with your email and
              password.
            </p>
            <div className="bg-white border rounded p-3">
              <code className="text-sm text-gray-800">
                {process.env.NEXT_PUBLIC_API_URL === 'http://localhost:3002'
                  ...
                  : 'https://houseofevents.com/account'}
              </code>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="font-semibold text-gray-800 mb-2">
              Step 2: Save the API Key generated
            </h4>
            <p className="text-gray-600 mb-3">
              Check your api key and save it for later use.
            </p>
            <div className="bg-white border rounded p-3">
              <code className="text-sm text-gray-800">
                hoa_sk_1234567890abcdef1234567890abcdef
              </code>
            </div>
          </div>
...

    {
      ...
      content: <TabbedSubscribe CodeBlock={CodeBlock} />,
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <div className="">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <hr className="mt-8 border-gray-100 border-t-2" />
        </div>
      </div>
        ...
        <div className="max-w-4xl">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
            ...
            <p className="text-gray-600 mb-6">
              Follow these three simple steps to start receiving event
              notifications:
            </p>
      ...
      <>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-gray-600 mb-3">
            ...
            and scroll to the "List of available Channels" section.
          </p>
        </div>
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="font-semibold text-gray-800 mb-2">
          ...
          <p className="text-gray-600 mb-3">
            Click on a channel row to auto-fill the Channel ID in the
            subscription form below the table.
          </p>
        </div>
        <div className="bg-gray-50 p-4 rounded-lg">
          <h4 className="font-semibold text-gray-800 mb-2">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-gray-600 mb-3">
            Click the{' '}
            <span className="font-semibold">"Subscribe to Channel"</span>{' '}
            button. You will see a success or error message based on the result.
          </p>
        </div>
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center">
            <CheckIcon className="h-5 w-5 text-green-600 mr-2" />
            <span className="text-green-800 font-medium">
              You're now subscribed to receive event notifications!
            </span>
          </div>
        </div>
      </>
